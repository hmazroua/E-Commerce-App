...
public class SDregisteration {
    ...
    public void personal_data()
    {
        ...
        Hooks.driver.findElement(By.id("FirstName")).sendKeys("Hassan");
        Hooks.driver.findElement(By.id("LastName")).sendKeys("Mazroua");
        ...
        // Fill Email Field
        Hooks.driver.findElement(By.id("Email")).sendKeys("hassan.mazro3a@gmail.com");

        // Fill Company Field
        Hooks.driver.findElement(By.id("Company")).sendKeys("TesTCompany");

        // Fill Password
        Hooks.driver.findElement(By.id("Password")).sendKeys("HnH@123");

        // Fill Confirm Password
        Hooks.driver.findElement(By.id("ConfirmPassword")).sendKeys("HnH@123");
    }
